...
var _Leonti$elm_time_picker$Main$doubleDigitFormat = function (number) {
	return (_elm_lang$core$Native_Utils.cmp(number, 10) < 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'0',
		_elm_lang$core$Basics$toString(number)) : _elm_lang$core$Basics$toString(number);
};
var _Leonti$elm_time_picker$Main$timePickerModel = F2(
	function (date, is24Hours) {
		return A2(
			_Leonti$elm_time_picker$TimePicker$init,
			{is24Hours: is24Hours, mainColor: '#00bcd4'},
			date);
	});
var _Leonti$elm_time_picker$Main$initialDate = A7(
	_rluiten$elm_date_extra$Date_Extra_Create$dateFromFields,
	2017,
	_rluiten$elm_date_extra$Date_Extra_Core$intToMonth(2),
	8,
	13,
	25,
	0,
	0);
var _Leonti$elm_time_picker$Main$init = {
	ctor: '_Tuple2',
	_0: {
		timePickerModel: A2(_Leonti$elm_time_picker$Main$timePickerModel, _Leonti$elm_time_picker$Main$initialDate, true),
		date: _Leonti$elm_time_picker$Main$initialDate,
		mdl: _debois$elm_mdl$Material$model,
		is24Hours: true
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _Leonti$elm_time_picker$Main$Model = F4(
	function (a, b, c, d) {
		return {timePickerModel: a, date: b, mdl: c, is24Hours: d};
	});
var _Leonti$elm_time_picker$Main$Toggle24h = function (a) {
	return {ctor: 'Toggle24h', _0: a};
};
var _Leonti$elm_time_picker$Main$TimeSelected = {ctor: 'TimeSelected'};
var _Leonti$elm_time_picker$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _Leonti$elm_time_picker$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'TimePickerMsg':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							timePickerModel: A2(_Leonti$elm_time_picker$TimePicker$update, _p0._0, model.timePickerModel)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'TimeSelected':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							date: _Leonti$elm_time_picker$TimePicker$selectedTime(model.timePickerModel)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Toggle24h':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							timePickerModel: A2(_Leonti$elm_time_picker$Main$timePickerModel, model.date, _p1),
							is24Hours: _p1
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return A3(_debois$elm_mdl$Material$update, _Leonti$elm_time_picker$Main$Mdl, _p0._0, model);
		}
	});
var _Leonti$elm_time_picker$Main$toggles = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A5(
				...
				_Leonti$elm_time_picker$Main$Mdl,
				{
					ctor: '::',
					_0: 0,
					_1: {ctor: '[]'}
				...
				{
					ctor: '::',
					_0: _debois$elm_mdl$Material_Toggles$value(model.is24Hours),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: _debois$elm_mdl$Material_Options$onToggle(
									_Leonti$elm_time_picker$Main$Toggle24h(true)),
								_1: {ctor: '[]'}
							}
						}
					}
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('24h'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A5(
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onToggle(
										_Leonti$elm_time_picker$Main$Toggle24h(false)),
									_1: {
										ctor: '::',
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('AM/PM'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _Leonti$elm_time_picker$Main$TimePickerMsg = function (a) {
	return {ctor: 'TimePickerMsg', _0: a};
};
var _Leonti$elm_time_picker$Main$dialogView = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$map,
						_Leonti$elm_time_picker$Main$TimePickerMsg,
					...
					{ctor: '[]'},
					{
						...
						_0: A5(
							...
							model.mdl,
							{
								...
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onClick(_Leonti$elm_time_picker$Main$TimeSelected),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _Leonti$elm_time_picker$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A3(
				...
				},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							_Leonti$elm_time_picker$Main$doubleDigitFormat(
								_elm_lang$core$Date$hour(model.date)),
							A2(
								_elm_lang$core$Basics_ops['++'],
								':',
								_Leonti$elm_time_picker$Main$doubleDigitFormat(
									_elm_lang$core$Date$minute(model.date))))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _Leonti$elm_time_picker$Main$toggles(model),
				_1: {
					ctor: '::',
					_0: _Leonti$elm_time_picker$Main$dialogView(model),
					_1: {
						ctor: '::',
						_0: A5(
							_debois$elm_mdl$Material_Button$render,
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Change Time'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('https://github.com/Leonti/elm-time-picker'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Project repo'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
...
var _Leonti$elm_time_picker$Main$main = _elm_lang$html$Html$program(
	{
		init: _Leonti$elm_time_picker$Main$init,
		view: _Leonti$elm_time_picker$Main$view,
		update: _Leonti$elm_time_picker$Main$update,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _Leonti$elm_time_picker$Main$main !== 'undefined') {
    _Leonti$elm_time_picker$Main$main(Elm['Main'], 'Main', undefined);
}
